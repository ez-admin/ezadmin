...
import com.ez.modules.login.service.LoginService;
...
public class LoginController extends BaseController{
    ...
    public String login(Model model,SysUser sysUser, HttpServletRequest request, HttpServletResponse response){
		String result = null;
		...
		httpSession.setAttribute("sysLog",log);
	...
	public String index(Model model,HttpServletRequest request){
		try {
			...
			if (sysuser != null) {
				...
				String userRights = sysuser.getOpright();
				//一级菜单
				...
				model.addAttribute("firstmenulist", menuTitleList);
			}else {
				return "ez/index/login";
			}
