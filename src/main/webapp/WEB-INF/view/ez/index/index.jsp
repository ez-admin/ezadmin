	...
	<div class="main-content">
		<div class="main-content-inner">
			...
			<div class="page-content">
				<!--浮动设置框-->
				<%@ include file="floatsetting.jsp"%>

				<%--<div id="jzts" style="display:none; width:100%; position:relative; z-index:99999999;">
					<div class="commitopacity" id="bkbgjz"></div>
					<div style="padding-left: 45%;padding-top: 1px;">
				...
				<div>
					<iframe name="mainFrame" id="mainFrame" frameborder="0" src="ez/syslogin/tab.do" style="margin:0 auto;width:100%;height:100%;"></iframe>
				</div>
...
<script src="static/assets/js/src/ace.searchbox-autocomplete.js"></script>
	...
	<!--引入属于此页面的js -->
	<script type="text/javascript" src="static/assets/js/myjs/index.js"></script>
