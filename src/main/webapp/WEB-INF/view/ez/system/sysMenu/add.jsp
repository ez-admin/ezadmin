	...
	<div class="form-group">
		...
		<div class="col-sm-10">
			<label class="radio-inline i-checks">
				<input type="radio" name="menuType" value="0">&nbsp;&nbsp;开发者菜单
			</label>
			<label class="radio-inline i-checks">
				<input type="radio" name="menuType" value="1" >&nbsp;&nbsp;系统菜单
			</label>
			<label class="radio-inline i-checks">
				<input type="radio" name="menuType" value="2" checked>&nbsp;&nbsp;业务菜单
			</label>
			<label class="radio-inline i-checks">
				<input type="radio" name="menuType" value="3" >&nbsp;&nbsp;前台菜单
			</label>
		</div>
	</div>
	<div class="form-group">
