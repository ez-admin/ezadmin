	...
	<div class="form-horizontal">
		<form id="formid" class="layui-form">
			<div class="form-group col-sm-6">
				...
				<div class="col-sm-9">
					<input type="text" name="roleName" required  placeholder="请输入角色名称" class="form-control">
				</div>
			</div>
			<div class="form-group col-sm-6">
				...
				<div class="col-sm-9">
					<input type="number" name="roleLvel" required maxlength="3" placeholder="请输入角色等级" class="form-control">
