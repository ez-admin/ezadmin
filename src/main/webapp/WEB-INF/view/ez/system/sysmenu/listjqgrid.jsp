...
<head>
	...
	<link rel="stylesheet" href="static/components/_mod/jquery-ui/jquery-ui.css" />
	<link rel="stylesheet" href="static/components/bootstrap-datepicker/dist/css/bootstrap-datepicker3.css" />
	<link rel="stylesheet" href="static/components/_mod/jqgrid/ui.jqgrid.css" />
	<!-- text fonts -->
...
<script src="static/components/jqGrid/js/jquery.jqGrid.js"></script>
<script src="static/components/jqGrid/js/i18n/grid.locale-cn.js"></script>
...
<script type="text/javascript">
	/*function cmainFrame(){
		var hmain = $("#main-tab .tab-content", parent.document).height();
		alert(hmain.height());
		alert($(".main-container").height());
		$(".main-container").height(hmain.height());
		//$(document.body).height(hmain.height());
		alert($(".main-container").height());
	}
	...
	jQuery(function($) {
		...
		jQuery(grid_selector).jqGrid({
			...
			mtype : "post",
			height: 396,
			colNames:['操作区', '菜单ID','菜单名称','菜单URL地址', '菜单父级ID', '菜单顺序','菜单图标' ,'菜单类型'],
			colModel:[
...
*/
				{name:'menuId',index:'MENU_ID', width:60,align : "center", sorttype:"int", editable: false},
				{name:'menuName',index:'MENU_NAME',width:90,align : "center", editable:true},
				{name:'menuUrl',index:'MENU_URL', width:150,align : "center",sortable:false,editable: true,edittype:"textarea", editoptions:{rows:"2",cols:"10"}},
				{name:'parentId',index:'PARENT_ID', width:70,align : "center", editable: true},
				{name:'menuOrder',index:'MENU_ORDER', width:90,align : "center", editable: true},
				{name:'menuIcon',index:'MENU_ICON', width:150,align : "center", editable: true},
				{name:'menuType',index:'MENU_TYPE', width:150,align : "center", editable: true,edittype:"checkbox",editoptions: {value:"1:2"},unformat: aceSwitch}
			],
			...
			editurl: "static/dummy.php",//nothing is saved
			caption: "菜单维护列表"
		...
		function enableTooltips(table) {
			$('.navtable .ui-pg-button').tooltip({container:'parent.document.body'});
			$(table).find('.ui-pg-div').tooltip({container:'parent.document.body'});
		}
