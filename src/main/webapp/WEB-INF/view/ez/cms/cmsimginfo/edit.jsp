...
<html lang="en">
<head>
	<title>所有图片管理编辑</title>
	<%@ include file="/WEB-INF/view/ez/index/top.jsp"%>
</head>
<body>
<div class="layui-field-box">
	<form id="formid" class="layui-form">
		<input type="hidden" name="emImageId" value="${cmsimginfo.emImageId}"/>
		<div class="layui-form-item">
			<label class="layui-form-label"><em class="required">*</em>图片名称:</label>
			<div class="layui-input-block">
				<input type="text" name="emImageName" value="${cmsimginfo.emImageName}"  required  lay-verify="required" placeholder="请输入图片名称" autocomplete="off" class="layui-input">
			</div>
		</div>
		<div class="layui-form-item">
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-block">
				...
				<input type="hidden" name="emImageUrl" value="${cmsimginfo.emImageUrl}">
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-block">
				<input type="text" name="emImageLinkurl" value="${cmsimginfo.emImageLinkurl}"  placeholder="请输入图片外链" autocomplete="off" class="layui-input">
			</div>
		</div>
		<div class="layui-form-item">
			<label class="layui-form-label"><em class="required">*</em>排序:</label>
			<div class="layui-input-block">
				<input type="number" name="emImageOrder" value="${cmsimginfo.emImageOrder}" lay-verify="required" maxlength="10"  autocomplete="off" class="layui-input">
			</div>
		</div>
		<div class="layui-form-item">
...
<script>
	...
	layui.use(['layer', 'form','jquery','upload','laydate'], function(){
        ...
        $.ajax({
            ...
            type: "POST",
            data:{selected:'${cmsimginfo.positionId}'},
		...
		form.on('submit(edit)', function(data){
			...
			$.ajax({
				url: "/ez/cms/cmsimginfo/update.do",
				type: "POST",
