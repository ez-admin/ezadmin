...
<form class="layui-form" id="formSearch">
	...
	<div class="layui-input-inline">
		<input name="emImageInserttimeBegin" type="text"  class="layui-input" placeholder="yyyy-mm-dd hh:mm:ss" lay-verify="date" onclick="layui.laydate({elem: this, istime: true, format: 'YYYY-MM-DD hh:mm:ss'})" />
	</div>
		--
	<div class="layui-input-inline">
