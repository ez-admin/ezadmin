...
<div class="container">
	<form id="formid" class="form-horizontal">
		...
		<div class="form-group">
			...
			<div class="col-sm-10">
				<input type="text" name="cmsName" value="${cmstag.cmsName}"  required="required" placeholder="请输入名称" autocomplete="off" class="form-control">
			</div>
		</div>
		<div class="form-group">
			<label class="col-sm-2 control-label"><em class="required">*</em>操作时间:</label>
			<div class="col-sm-10">
				<input type="text" name="cmsCreationTime" value="<fmt:formatDate value='${cmstag.cmsCreationTime}' type='both' pattern='yyyy-MM-dd'/>"   placeholder="yyyy-mm-dd" autocomplete="off" class="form-control" onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:00'});">
			</div>
		</div>
		<div class="form-group">
			<label class="col-sm-2 control-label"><em class="required">*</em>文档数量:</label>
			<div class="col-sm-10">
				<input type="number" name="cmsRefers" value="${cmstag.cmsRefers}" lay-verify="required" maxlength="10"  autocomplete="off" class="form-control">
			</div>
		</div>
		<div class="form-group">
			<div class="col-sm-10">
