...
<div class="container">
	<form id="formid" class="form-horizontal">
		...
		<div class="form-group">
			...
			<div class="col-sm-10">
				<input type="text" name="emVideoTitle" lay-verify="required" placeholder="请输入视频标题" autocomplete="off" class="form-control">
			</div>
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			...
			<div class="col-sm-10">
				...
				<input type="hidden" name="emVideoPicpath">
				<img id="emVideoPicpath" src="" alt="" width="80%">
			</div>
		</div>
		<div class="form-group">
			...
			<div class="col-sm-10">
				...
				<input type="hidden" name="emVideoPath" lay-verify="required">
				<video src="" id="emVideoPath"  controls="controls"  width="60%">
				</video>
			</div>
		</div>
		<div class="form-group">
			...
			<div class="col-sm-10">
				<input type="number" name="emVideoOrder" value="1"  maxlength="10"  autocomplete="off" class="form-control">
			</div>
		</div>
		<div class="form-group">
...
<script>
    ...
    /*layui.use(['layer', 'form','jquery','laydate','upload','element'], function(){
		...
		form.on('submit(add)', function(data){
			...
			$.ajax({
				url: "/ez/cms/cmsinfovideo/add.do",
				type: "POST",
				data:$('#formid').serialize(),// 你的formid
				success: function (result) {
					if("suc"==(result.msg)){
