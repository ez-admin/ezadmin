...
<form role="form" id="formSearch">
    <shiro:hasPermission name="cmsinfo_query">
        ...
        <%--<div class="form-group">
            <input name="cmsInfoInserttimeBegin" type="text"  class="form-control" placeholder="请选择开始时间" lay-verify="date" onclick="layui.laydate({elem: this, istime: true, format: 'YYYY-MM-DD hh:mm:ss'})" />
        </div>
            --
        <div class="form-group">
