    ...
    $.fn.aceaddtab = function (options) {
        ...
        var _loadContent = function () {
            ...
            if (_tabs.length == 1) {
                ...
                tabTitles += " <i class=\"green ace-icon fa " + opt.icon + " bigger-110\"></i>";
                tabTitles += opt.title;
                //tabTitles += "<i class=\"red ace-icon fa fa-remove bigger-110\"></i>";
                tabTitles += "</a>";
                //---------------------------------------------------
                tabTitles += "</li>";
                tabTitles += "</ul>"
            ...
            if ($("#" + htmlID + " > ul > li[class*='dropdown']").size() == 1) {
                ...
                listHtml += " <i class=\"green ace-icon fa " + opt.icon + " bigger-110\"></i>";
                listHtml += opt.title;
                listHtml += "<i class=\"red ace-icon fa fa-remove bigger-110\" style=\"cursor:pointer\"></i>";
                listHtml += "</a>";
                listHtml += "</li>";
        ...
        var _tabList = function () {
            ...
            if ($("#" + htmlID + " > ul").outerHeight(true) < 50) {
                ...
                for (var i = 0; i < tabs.length; i++) {
                    ...
                    tabTitles += " <i class=\"green ace-icon fa " + tabs[i].icon + " bigger-110\"></i>";
                    tabTitles += tabs[i].title;
                    if (i != 0) {
                        tabTitles += "<i class=\"red ace-icon fa fa-remove bigger-110\" style=\"cursor:pointer\"></i>";
                    }
                    tabTitles += "</a>";
                    $("#" + htmlID + " > ul").append(tabTitles);
                }
            ...
            if ($("#" + htmlID + " > ul").outerHeight(true) > 50) {
                ...
                listTab += "<i class=\"green ace-icon fa fa-list bigger-120\" ></i>";
                listTab += "</a>";
                ...
                for (var i = 0; i < tabs.length; i++) {
                    if (i > showCount - 1) {
                        ...
                        listHtml += " <i class=\"green ace-icon fa " + tabs[i].icon + " bigger-110\"></i>";
